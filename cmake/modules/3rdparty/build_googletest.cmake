set(BUILD_3RDPARTY_NAME "googletest")
set(BUILD_3RDPARTY_FILENAME "googletest-release-1.8.1.tar.gz")

message(STATUS "BUILD NAME:(googletest)")
...
if(MSVC)
  if(NOT MSVC_USE_STATIC_RUNTIME_LIBRARY)
    set(GOOGLE_TEST_CONFIG -Dgtest_force_shared_crt=ON)
  endif()
endif()
