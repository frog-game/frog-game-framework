set(BUILD_3RDPARTY_NAME "lpeg")
set(BUILD_3RDPARTY_FILENAME "lpeg-1.0.2.tar.gz")

message(STATUS "BUILD NAME:(lpeg)")
...
execute_process(COMMAND ${CMAKE_COMMAND}
    ...
    -DLUA_INSTALL_DIR=${FROG_3RDPARTY_BINARY_DIR}/install/lua
    -G ${CMAKE_GENERATOR}
...
file(MAKE_DIRECTORY ${CMAKE_INSTALL_PREFIX}/bin/modules)

if(MACOS)
    execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${FROG_3RDPARTY_BINARY_DIR}/install/lpeg/lib/lpeg.dylib ${CMAKE_INSTALL_PREFIX}/bin/modules)
elseif(WINDOWS)
    execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${FROG_3RDPARTY_BINARY_DIR}/install/lpeg/lib/lpeg.dll ${CMAKE_INSTALL_PREFIX}/bin/modules)
elseif(LINUX)
    execute_process(COMMAND ${CMAKE_COMMAND} -E copy ${FROG_3RDPARTY_BINARY_DIR}/install/lpeg/lib/lpeg.so ${CMAKE_INSTALL_PREFIX}/bin/modules)
endif()